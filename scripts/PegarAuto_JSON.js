// =============================================================
//  PegarAuto_JSON.js  —  script DEDICADO del Modo automático
//  QuarkXPress 2018 v14.2 (QX.js)  ·  desplegar como "Pegar Auto.js"
// -------------------------------------------------------------
//  Fase 1: idéntico al all-in-one ("Pegar Todo.js" / PegarNota_JSON.js):
//    pega volanta, título, bajada, epígrafe, cuerpo, fotos, avisos, textuales,
//    dato, número y QR según sección/maqueta.
//  Fase 2 (pendiente): se le agregará la GEOMETRÍA de cajas (setear x/y/ancho/alto
//    de textual/dato/número/qr/foto a su posición final) para el armado autónomo.
//  No tocar "Pegar Todo.js" (manual): este es su clon dedicado al modo automático.
// =============================================================
(function () {
  try {
